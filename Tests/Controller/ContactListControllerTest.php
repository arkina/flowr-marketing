...
class ContactListControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'contactlist[name]' => 'Lorem ipsum dolor sit amet',
            'contactlist[enabled]' => true,
            'contactlist[created]' => new \DateTime(),
            'contactlist[updated]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/contactlist/new');
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'contactlist_filter[name]' => 'First%',
            'contactlist_filter[enabled]' => true,
            'contactlist_filter[created]' => new \DateTime(),
            'contactlist_filter[updated]' => new \DateTime(),
