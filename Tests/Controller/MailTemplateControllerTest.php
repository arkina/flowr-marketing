...
namespace Flower\ModelBundle\Tests\Controller;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class MailTemplateControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/mailtemplate/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'mailtemplate[name]' => 'Lorem ipsum dolor sit amet',
            'mailtemplate[type]' => 'Lorem ipsum dolor sit amet',
            'mailtemplate[content]' => 'Lorem ipsum dolor sit amet',
            'mailtemplate[created]' => new \DateTime(),
            'mailtemplate[updated]' => new \DateTime(),
            'mailtemplate[enabled]' => true,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/mailtemplate/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'mailtemplate[name]' => 'Changed',
            'mailtemplate[type]' => 'Changed',
            'mailtemplate[content]' => 'Changed',
            'mailtemplate[created]' => new \DateTime(),
            'mailtemplate[updated]' => new \DateTime(),
            'mailtemplate[enabled]' => true,
