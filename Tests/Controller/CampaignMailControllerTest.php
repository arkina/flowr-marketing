...
class CampaignMailControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/campaignmail/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'campaignmail[name]' => 'Lorem ipsum dolor sit amet',
            'campaignmail[mailFrom]' => 'Lorem ipsum dolor sit amet',
            'campaignmail[mailSubject]' => 'Lorem ipsum dolor sit amet',
            'campaignmail[mailFromName]' => 'Lorem ipsum dolor sit amet',
            'campaignmail[enabled]' => true,
            'campaignmail[created]' => new \DateTime(),
            'campaignmail[updated]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/campaignmail/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'campaignmail[name]' => 'Changed',
            'campaignmail[mailFrom]' => 'Changed',
            'campaignmail[mailSubject]' => 'Changed',
            'campaignmail[mailFromName]' => 'Changed',
            'campaignmail[enabled]' => true,
            'campaignmail[created]' => new \DateTime(),
            'campaignmail[updated]' => new \DateTime(),
